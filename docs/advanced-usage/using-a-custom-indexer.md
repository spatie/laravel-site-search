...
The implementation of `entries()` of the `DefaultIndexer` will chop up your content in pieces of a few sentences long. This keeps individual records small, which improves search relevance and performance.
